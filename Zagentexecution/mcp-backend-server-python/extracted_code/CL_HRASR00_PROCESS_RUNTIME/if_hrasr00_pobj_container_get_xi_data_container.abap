METHOD if_hrasr00_pobj_container~get_xi_data_container.
...
*  DATA image_container       TYPE hrasr00image_container.
  ...
  DATA lt_xi_dat_containers      TYPE pobjt_containers.
  DATA ls_xi_dat_containers      TYPE pobjs_container.
  DATA xi_data_container_wa TYPE hrasr00image_container.
  DATA lo_pobj_instance TYPE REF TO if_pobj_process_object.
  DATA cont_attribute_wa TYPE pobjs_ind_nam_val_ops.
  CLEAR xi_data_container.
...
* check auth against each data container
      ...
      ls_containers_read-logical_anchor = c_la_xidat_cont_process.
      ...
      CALL METHOD lo_pobj_instance->read
        ...
        IMPORTING
          containers       = lt_xi_dat_containers.

      READ TABLE lt_xi_dat_containers INTO ls_xi_dat_containers INDEX 1.
      xi_data_container = ls_xi_dat_containers-container_content.
