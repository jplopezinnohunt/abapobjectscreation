METHOD if_hrasr00_pobj_attachment~get_all_attachments_process.
  ...
  DATA attachment_guids TYPE TABLE OF bapiguid.
...
*call the read method of the pobj api layer by passing the mapped parameter.
      ...
      SORT lt_attachments_out BY attachment_key-logical_guid ASCENDING.
