...
*   Get actor infos (current user)
    ...
    CASE iv_actor.
      WHEN c_hra.
*       HRA returns request to employee
*       1-Update table of  request
        lo_util->update_req_table( EXPORTING  iv_guid = iv_guid
                                     iv_new_status = c_req_returned_employee
                                     iv_next_actor = c_employee
...
*       3-Update coment log
      ...
      WHEN c_hro.
*       HRO returns request to HRA
*       1-Update table of  request
        lo_util->update_req_table( EXPORTING  iv_guid = iv_guid
                                     iv_new_status = c_req_returned_hra
                                     iv_next_actor = c_hra
                                     iv_upd_first_name = lv_first_name
                                     iv_upd_last_name = lv_last_name
                                     iv_upd_pernr = lv_pernr
