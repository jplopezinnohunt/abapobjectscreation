...
*   Get actor infos (current user)
    ...
    CASE iv_actor.
      WHEN c_hra .
*       HRA approves,  end of process
*       If status of request is 'validated by HRA' means claim on advance and Modify infotype
*       1-Creation of infotype 0965 or update
        handle_infotype_0965( EXPORTING iv_guid = iv_guid
...
*       2-Update table of  request
        lo_util->update_req_table( EXPORTING  iv_guid = iv_guid
                                     iv_new_status = c_req_approved_hra
