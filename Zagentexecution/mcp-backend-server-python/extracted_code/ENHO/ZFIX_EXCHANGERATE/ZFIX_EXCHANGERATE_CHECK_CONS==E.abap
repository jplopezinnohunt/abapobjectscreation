...
*DATA yylo_fm_use_br_avc_funds TYPE REF TO ycl_fm_use_br_avc_funds.
...
*Class to export class and consume in other step.
*yylo_fm_use_br_avc_funds = ycl_fm_use_br_avc_funds=>set_instance( )..
*yylo_fm_use_br_avc_funds->mo_ef_document = m_r_doc.
