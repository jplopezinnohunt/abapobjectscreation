"""
write_ccimp_like.py
Use LIKE to declare variable compatible with SIW_TAB_CODE rows.
ABAP allows: DATA: lv_line LIKE LINE OF lt_code.
"""
import os, sys
...
def write_include_abap(include_name, code_lines):
    """Write ABAP include code using LIKE LINE OF for type compatibility."""
    abap_lines = [
        "REPORT Z_WRITE_INCL.",
        "DATA: lt_code TYPE siw_tab_code.",
        "DATA: lv_line LIKE LINE OF lt_code.",
        "",
    ]
...
if __name__ == "__main__":
    # First: Use LIKE LINE OF approach with test data
    write_include_abap("ZCL_CRP_PROCESS_REQ============CCIMP", [
