...
- Element IDs (C109/C111 toolbar/tree)
- Workflows for project, entity, association, service registration
- Troubleshooting table
- Integration points

This file is kept to avoid broken references. Use `sap_segw` going forward.
