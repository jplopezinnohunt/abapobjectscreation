...
| **H48** | **Investigate KU-030/031/032: YRGGBS00 substitution mechanics (2/3 DONE session #054)** | #054 | FI/Investigation | 3 KUs. **KU-030 PARTIALLY_ANSWERED**: guard `IF bseg_xref1 = space` confirmed commented at YRGGBS00:998. ASYMMETRY discovered: UXR2 at line 1026 keeps its guard. Consequence: UXR1 unconditionally overwrites user-typed XREF1 — root cause of DQ-019 21K manual edits. WHO/WHEN commented still requires SE38 version history. **KU-031 ANSWERED**: substitution step prerequisites are PROCEDURAL inside YRGGBS00 FORM bodies, not declarative. GB922 stores step sequence (17 UNES rows), GB901 holds boolean expressions for VALIDATIONS (not substitutions), GB905/GB921 not populated in P01. **KU-032 BLOCKED**: F110 vs F-53 asymmetry cannot come from FORM itself (no tcode filter). Needs ST05 trace in TS3 — user-assisted live SAP work. New **claim #47** created (UXR1/UXR2 asymmetric defect, TIER_1). New YRGGBS00 annotation (CRITICAL, line 998). Ready for H45 scoped + H46 preventive fix option b (guard restoration, single-line change). |
