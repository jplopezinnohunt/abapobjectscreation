...
- **Coordinator**: `.claude/skills/coordinator/SKILL.md` — routes by process type
- **PSM Domain Agent**: `.claude/skills/psm_domain_agent/SKILL.md` — FM/budget
- **HCM Domain Agent**: `.claude/skills/hcm_domain_agent/SKILL.md` — HR/employee lifecycle
- **FI Domain Agent**: `.claude/skills/fi_domain_agent/SKILL.md` — GL/validation/substitution
...
| G63 | **Formalize Discovery Patterns as ecosystem skill** | #039 | Independent of Brain v2. 6 proven patterns (Payment E2E, P2P, Integration, Bank Recon, Code+BAdI tracing, Transport Impact). Create `.claude/skills/discovery_patterns/SKILL.md` + promote to ecosystem-coordinator as `enterprise-discovery` skill. |
