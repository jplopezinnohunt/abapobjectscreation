...
> - **H72 [ðŸ”´ AUDIT]** â€” **P2P 3-way-match violations:** 70 IR-before-GR ($713,341, claim #214) + 32 invoice+payment SoD (T_ENG/I_MARQUAND, #213) + 17% PO-no-receipt (open commitments). Remediation + recurring detector.
...
*Instrumentos que ya existen:* `gl_alignment_check.py` Â· `ob09_vs_variant_check.py` Â·
