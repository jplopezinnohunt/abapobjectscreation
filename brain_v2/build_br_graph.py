...
NODES = [
 ...
 {"id": "IMPACT_STAFF", "kind": "MEASUREMENT",
  "what": "USD 1,982,154.59 and EUR 796,418.86 for 2026 to July (posted runs only — claim #467), "
          "netting to EXACTLY zero per currency — a self-balancing reclassification, not a "
          "residual. SUPERSEDES the first figure, USD 20,523,434.48 / EUR 8,057,168.94, which "
          "summed ALL payroll postings including the 1,828 of 2,316 runs (90% of the amount) "
          "that were simulations never reaching FI (claim #465, corrected by #467)",
  "content_in": "budget_rate_enhancements.json ._THE_TWO_MECHANISMS.personnel.the_real_mechanism._AS_DESIGNED_VS_AS_RUN_s098._THE_GOLDEN_IS_NOW_PURGED / .the_impact_MEASURED._CORRECTED_simulation_runs"},
