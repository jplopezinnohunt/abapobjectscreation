...
REPORT  YAM_BIENNIUM LINE-SIZE 170 LINE-COUNT 58.
...
PARAMETERS: P_BUKRS LIKE ANLA-BUKRS DEFAULT 'UNES' OBLIGATORY,
            P_BYEAR LIKE ANLC-GJAHR OBLIGATORY. "biennium start

SELECT-OPTIONS: P_GJAHR FOR ANLC-GJAHR NO-DISPLAY,
...
SELECT *
  ...
  SELECT *
    ...
    IF ANLZ-BDATU(4) >= P_GJAHR-HIGH AND
       ANLZ-ADATU(4) <= P_GJAHR-HIGH.
      W_STORT = ANLZ-STORT.
      W_GSBER = ANLZ-GSBER.
    ENDIF.
  ENDSELECT. "anlz
