...
FORM 01_SELECT_BSIS.
*{   INSERT         A01K920068                                        4
DATA WA_T_BSIS_ALL LIKE LINE OF T_BSIS_ALL.
REFRESH T_BSIS_ALL.

*}   INSERT

*{   REPLACE        A01K920068                                        3
...
*\  endloop.
  CLEAR WA_T_BSIS_ALL.
  LOOP AT TSAKO WHERE Y_BQ_AC = ' '.
     SELECT * FROM BSIS INTO WA_T_BSIS_ALL
                          WHERE BUKRS EQ TSAKO-BUKRS
                          AND HKONT EQ TSAKO-HKONT
                          AND BUDAT LE P_BUDAT
                          AND SHKZG EQ TSAKO-SHKZG.
 IF SY-SUBRC EQ 0.
 IF  ( WA_T_BSIS_ALL-HKONT+3(7) = '1175012'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1175013'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1175023'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1175033'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1375012'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1375013'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1375023'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1375033' )
 AND WA_T_BSIS_ALL-BELNR(2) = '86'
 AND  ( WA_T_BSIS_ALL-ZUONR+4(1) = 1 OR WA_T_BSIS_ALL-ZUONR+4(1) = 2
 OR WA_T_BSIS_ALL-ZUONR+4(1) = 3  OR WA_T_BSIS_ALL-ZUONR+4(1) = 6 OR WA_T_BSIS_ALL-ZUONR+4(1) = 7
 OR WA_T_BSIS_ALL-ZUONR+4(1) = 8 ).
          MOVE WA_T_BSIS_ALL-ZUONR TO WA_T_BSIS_ALL-ZUONR_HR.
          MOVE WA_T_BSIS_ALL-ZUONR(7) TO WA_T_BSIS_ALL-ZUONR.
*          move '1' to  wa_t_bsis_all-paytype. "paiment collectif
          APPEND WA_T_BSIS_ALL TO T_BSIS_ALL.

 ELSEIF ( WA_T_BSIS_ALL-HKONT+3(7) = '1175012'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1175013'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1175023'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1175033'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1375012'
 ...
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1375033' )
 AND WA_T_BSIS_ALL-BELNR(2) = '86'
 AND WA_T_BSIS_ALL-ZUONR+4(1) NE 1
 AND WA_T_BSIS_ALL-ZUONR+4(1) NE 2
 AND  WA_T_BSIS_ALL-ZUONR+4(1) NE 3
 AND WA_T_BSIS_ALL-ZUONR+4(1) NE 6
 AND WA_T_BSIS_ALL-ZUONR+4(1) NE 7
 AND  WA_T_BSIS_ALL-ZUONR+4(1) NE 8 .
          MOVE WA_T_BSIS_ALL-ZUONR TO WA_T_BSIS_ALL-ZUONR_HR.
          MOVE WA_T_BSIS_ALL-ZUONR+7(7) TO WA_T_BSIS_ALL-ZUONR.
*          move '2' to  wa_t_bsis_all-paytype. "paiment individuel
          APPEND WA_T_BSIS_ALL TO T_BSIS_ALL.

  ELSEIF  ( WA_T_BSIS_ALL-HKONT+3(7) = '1275012'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1275013'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1275023'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1275033'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1375012'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1375013'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1375023'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1375033' )
 AND WA_T_BSIS_ALL-BELNR(2) = '35'
 AND WA_T_BSIS_ALL-BLART ='Z1'
 AND WA_T_BSIS_ALL-ZUONR(3) = 'DME'.
*suppression de 'DME0' rajouté par FF.5 / Collectif
        MOVE WA_T_BSIS_ALL-ZUONR TO WA_T_BSIS_ALL-ZUONR_HR.
        MOVE WA_T_BSIS_ALL-ZUONR+4(7) TO WA_T_BSIS_ALL-ZUONR.
        APPEND WA_T_BSIS_ALL TO T_BSIS_ALL.
        CLEAR WA_T_BSIS_ALL.
  ELSEIF  ( WA_T_BSIS_ALL-HKONT+3(7) = '1275012'
 OR WA_T_BSIS_ALL-HKONT+3(7) = '1275013'
 ...
 AND WA_T_BSIS_ALL-BLART ='Z1'
 AND WA_T_BSIS_ALL-ZUONR(3) <> 'DME'.
*suppression '310' rajouté par FF.5  / individuel
          MOVE WA_T_BSIS_ALL-ZUONR TO WA_T_BSIS_ALL-ZUONR_HR.
          MOVE WA_T_BSIS_ALL-ZUONR+3(7) TO WA_T_BSIS_ALL-ZUONR.
          APPEND WA_T_BSIS_ALL TO T_BSIS_ALL.
          CLEAR WA_T_BSIS_ALL.
 ELSE.
        APPEND WA_T_BSIS_ALL TO T_BSIS_ALL.
...
FORM 03_SELECT_BSEG.
  ...
  LOOP AT TSAKO WHERE Y_BQ_AC = ' '.
*!!!!!!!!!!!!!!!!! A faire - décomposer la selection en deux parties
* BSIS pour AUGDT
* voir quelle table pour augdt gt p_budat
...
*AAHOUNOU09012007
       AND GJAHR >= 2004
       AND ( AUGDT EQ 0 OR AUGDT GT P_BUDAT ).
...
*        t_corresp-DMBTR  =  t_bsis_all-DMBTR.
*        append t_corresp.
*      endloop.
*
