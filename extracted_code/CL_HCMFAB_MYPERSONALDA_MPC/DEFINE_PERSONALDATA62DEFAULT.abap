method DEFINE_PERSONALDATA62DEFAULT.
*&---------------------------------------------------------------------*
...
***********************************************************************************************************************************
*   ENTITY - PersonalData62Default
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'PersonalData62Default' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->set_label_from_text_element( iv_text_element_symbol = '180' iv_text_element_container = 'CL_HCMFAB_MYPERSONALDA_MPC_EXT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'HCMFAB_S_PERS_PERSONALDATA_62'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'PersonalData62DefaultSet' ). "#EC NOTEXT
