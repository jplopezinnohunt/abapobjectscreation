method DEFINE_VALUEHELPMILITARY.
*&---------------------------------------------------------------------*
...
***********************************************************************************************************************************
*   ENTITY - ValueHelpMilitary
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ValueHelpMilitary' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property = lo_entity_type->create_property( iv_property_name = 'MilitaryText' iv_abap_fieldname = 'TEXT' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'MilitaryId' iv_abap_fieldname = 'VALUE' ). "#EC NOTEXT
lo_property->set_label_from_text_element( iv_text_element_symbol = '101' iv_text_element_container = 'CL_HCMFAB_MYPERSONALDA_MPC_EXT' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 40 ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'HCMFAB_S_PERS_VH_MILITARY'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ValueHelpMilitarySet' ). "#EC NOTEXT
