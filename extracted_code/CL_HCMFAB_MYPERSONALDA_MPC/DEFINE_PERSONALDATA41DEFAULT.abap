method DEFINE_PERSONALDATA41DEFAULT.
*&---------------------------------------------------------------------*
...
***********************************************************************************************************************************
*   ENTITY - PersonalData41Default
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'PersonalData41Default' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_true ).
lo_property = lo_entity_type->create_property( iv_property_name = 'RegistrationNumber' iv_abap_fieldname = 'REGNO' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_true ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'LastNameHangul' iv_abap_fieldname = 'LNMHG' ). "#EC NOTEXT
lo_property->set_label_from_text_element( iv_text_element_symbol = '153' iv_text_element_container = 'CL_HCMFAB_MYPERSONALDA_MPC_EXT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->set_nullable( abap_true ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'FirstNameHangul' iv_abap_fieldname = 'FNMHG' ). "#EC NOTEXT
lo_property->set_label_from_text_element( iv_text_element_symbol = '154' iv_text_element_container = 'CL_HCMFAB_MYPERSONALDA_MPC_EXT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 40 ). "#EC NOTEXT
lo_property->set_creatable( abap_true ).
lo_property->set_updatable( abap_true ).
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_true ).
lo_property = lo_entity_type->create_property( iv_property_name = 'LastNameHanja' iv_abap_fieldname = 'LNMCH' ). "#EC NOTEXT
lo_property->set_label_from_text_element( iv_text_element_symbol = '155' iv_text_element_container = 'CL_HCMFAB_MYPERSONALDA_MPC_EXT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_true ).
lo_property = lo_entity_type->create_property( iv_property_name = 'FirstNameHanja' iv_abap_fieldname = 'FNMCH' ). "#EC NOTEXT
lo_property->set_label_from_text_element( iv_text_element_symbol = '156' iv_text_element_container = 'CL_HCMFAB_MYPERSONALDA_MPC_EXT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 20 ). "#EC NOTEXT
lo_property->set_creatable( abap_true ).
lo_property->set_updatable( abap_true ).
...
lo_property->set_nullable( abap_true ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'FormOfAddressId' iv_abap_fieldname = 'ANREX' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'HCMFAB_S_PERS_PERSONALDATA_41'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'PersonalData41DefaultSet' ). "#EC NOTEXT
