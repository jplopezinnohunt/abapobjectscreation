...
***********************************************************************************************************************************
*   ENTITY - ValueHelpTitle
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ValueHelpTitle' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property = lo_entity_type->create_property( iv_property_name = 'TitelType' iv_abap_fieldname = 'ART' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'TitelId' iv_abap_fieldname = 'TITEL' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'TitelText' iv_abap_fieldname = 'TTOUT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 15 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'HCMFAB_S_PERS_VH_TITLE'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ValueHelpTitleSet' ). "#EC NOTEXT
