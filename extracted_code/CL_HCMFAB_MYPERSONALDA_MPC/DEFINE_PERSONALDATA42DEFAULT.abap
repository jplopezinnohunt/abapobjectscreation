method DEFINE_PERSONALDATA42DEFAULT.
*&---------------------------------------------------------------------*
...
***********************************************************************************************************************************
*   ENTITY - PersonalData42Default
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'PersonalData42Default' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property = lo_entity_type->create_property( iv_property_name = 'MaritalStatusText' iv_abap_fieldname = 'FTEXT' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_true ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'AlternateName' iv_abap_fieldname = 'ALNAM' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->set_nullable( abap_true ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'TitleText' iv_abap_fieldname = 'ATEXT' ). "#EC NOTEXT
...
lo_property = lo_entity_type->create_property( iv_property_name = 'GenderText' iv_abap_fieldname = 'GESCX' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_true ).
lo_property = lo_entity_type->create_property( iv_property_name = 'FDateMarital' iv_abap_fieldname = 'FADAY' ). "#EC NOTEXT
lo_property->set_label_from_text_element( iv_text_element_symbol = '127' iv_text_element_container = 'CL_HCMFAB_MYPERSONALDA_MPC_EXT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->set_nullable( abap_true ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'FMonthMarital' iv_abap_fieldname = 'FAMON' ). "#EC NOTEXT
lo_property->set_label_from_text_element( iv_text_element_symbol = '126' iv_text_element_container = 'CL_HCMFAB_MYPERSONALDA_MPC_EXT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 2 ). "#EC NOTEXT
lo_property->set_creatable( abap_true ).
lo_property->set_updatable( abap_true ).
...
lo_property->set_nullable( abap_true ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'FYearAfterMinguo' iv_abap_fieldname = 'FAYAR1' ). "#EC NOTEXT
lo_property->set_label_from_text_element( iv_text_element_symbol = '128' iv_text_element_container = 'CL_HCMFAB_MYPERSONALDA_MPC_EXT' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_true ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'FYearBeforeMinguo' iv_abap_fieldname = 'FAYAR2' ). "#EC NOTEXT
lo_property->set_label_from_text_element( iv_text_element_symbol = '129' iv_text_element_container = 'CL_HCMFAB_MYPERSONALDA_MPC_EXT' ). "#EC NOTEXT
lo_property->set_type_edm_int16( ).
lo_property->set_creatable( abap_true ).
lo_property->set_updatable( abap_true ).
lo_property->set_sortable( abap_false ).
lo_property->set_nullable( abap_true ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'GDateOfBirth' iv_abap_fieldname = 'GBDAY' ). "#EC NOTEXT
lo_property->set_label_from_text_element( iv_text_element_symbol = '127' iv_text_element_container = 'CL_HCMFAB_MYPERSONALDA_MPC_EXT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 2 ). "#EC NOTEXT
lo_property->set_creatable( abap_true ).
...
lo_property->set_nullable( abap_true ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'GeneralName' iv_abap_fieldname = 'KTEXT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->set_nullable( abap_true ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'GMonthOfBirth' iv_abap_fieldname = 'GBMON' ). "#EC NOTEXT
lo_property->set_label_from_text_element( iv_text_element_symbol = '126' iv_text_element_container = 'CL_HCMFAB_MYPERSONALDA_MPC_EXT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 2 ). "#EC NOTEXT
lo_property->set_creatable( abap_true ).
...
lo_property->set_nullable( abap_true ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'YearAfterMinguo' iv_abap_fieldname = 'GBYAR1' ). "#EC NOTEXT
lo_property->set_label_from_text_element( iv_text_element_symbol = '128' iv_text_element_container = 'CL_HCMFAB_MYPERSONALDA_MPC_EXT' ). "#EC NOTEXT
lo_property->set_type_edm_int16( ).
lo_property->set_creatable( abap_true ).
lo_property->set_updatable( abap_true ).
...
lo_property->set_nullable( abap_true ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'YearBeforeMinguo' iv_abap_fieldname = 'GBYAR2' ). "#EC NOTEXT
lo_property->set_label_from_text_element( iv_text_element_symbol = '129' iv_text_element_container = 'CL_HCMFAB_MYPERSONALDA_MPC_EXT' ). "#EC NOTEXT
lo_property->set_type_edm_int16( ).
lo_property->set_creatable( abap_true ).
lo_property->set_updatable( abap_true ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'HCMFAB_S_PERS_PERSONALDATA_42'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'PersonalData42DefaultSet' ). "#EC NOTEXT
