...
$mapping = @{
    "FM_BUDGETING"   = @("ZXFMDT*_RPY.abap", "ZXFMDT*_RPY.abap", "ZXFMYU*_RPY.abap", "ZXFMCU*_RPY.abap")
    "FM_MASTER_DATA" = @("ZXFMFUND*_RPY.abap")
    "MM_PROCUREMENT" = @("ZXM06*_RPY.abap")
    "PS_PROJECTS"    = @("YJWB001_RPY.abap", "ZXCN1U01_RPY.abap", "ZXCN1U21_RPY.abap", "ZXCN1U22_RPY.abap")
