...
| 6 | [.claude/skills/sap_incident_analyst/SKILL.md](../../.claude/skills/sap_incident_analyst/SKILL.md) — Core Principles expanded from 5 → 12 rules; Step 3 Gold DB pull now has mandatory GGB-table extraction list and Gold DB schema gotchas | Skill |
